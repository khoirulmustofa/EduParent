<template>
    <ion-page>
        <ion-content :fullscreen="true" class="bg-gray-50 font-sans">
            ...
            <div class="relative z-10 flex flex-col h-full px-8 justify-center">
                ...
                <form class="space-y-2" @submit.prevent>
                    ...
                    <button
                        class="w-full bg-gradient-to-r from-green-400 to-green-600 text-white font-bold !py-4 !rounded-2xl !shadow-xl !shadow-green-200 active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2 mt-4">
                        <span>Sign In</span>
